...
//
// On Tue Oct  4 10:37:00 CEST 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkjtagdtm(CLK,
  ...
  wire [39 : 0] x1__h4045, x1__h4149, x1__h4565;
  wire [33 : 0] x__h4017;
  wire [31 : 0] x__h3324, x__h3338, x__h4885;
  wire [27 : 0] r1__read__h3385;
  wire [21 : 0] r1__read__h3397;
  wire [19 : 0] r1__read__h3409;
  wire [16 : 0] r1__read__h3421;
  wire [15 : 0] r1__read__h3433;
  wire [14 : 0] r1__read__h3445;
  wire [4 : 0] x__h4690;
  wire [3 : 0] IF_wr_tms_whas__6_AND_wr_tms_wget__8_4_THEN_2__ETC___d67;
  wire [1 : 0] spliced_bits__h4209;
  ...
  assign MUX_response_status_write_1__VAL_2 =
	     response_from_DM_EMPTY_N ? spliced_bits__h4209 : 2'd3 ;
  ...
  assign dmiaccess_shiftreg_EN_port0__write =
	     ...
	     (tapstate == 4'd0 ||
	      tapstate_EQ_3_8_AND_crossed_instruction_wget___ETC___d152) ;
  always@(tapstate or x1__h4565 or x1__h4149 or x1__h4045)
  begin
    case (tapstate)
      4'd0: dmiaccess_shiftreg_port0__write_1 = 40'd0;
      4'd3: dmiaccess_shiftreg_port0__write_1 = x1__h4149;
      4'd4: dmiaccess_shiftreg_port0__write_1 = x1__h4045;
      default: dmiaccess_shiftreg_port0__write_1 = x1__h4565;
    endcase
  end
  ...
  // register dmistat
  assign dmistat_D_IN = spliced_bits__h4209 ;
  assign dmistat_EN =
  ...
  // register dtmcontrol_shiftreg
  assign dtmcontrol_shiftreg_D_IN = (tapstate == 4'd3) ? x__h3324 : x__h3338 ;
  assign dtmcontrol_shiftreg_EN =
	     (tapstate == 4'd3 || tapstate == 4'd4) && instruction == 5'h10 ;

  // register idcode_sr
  always@(tapstate or x__h4885)
  begin
    case (tapstate)
      4'd0, 4'd3: idcode_sr_D_IN = 32'h100039D3;
      default: idcode_sr_D_IN = x__h4885;
    endcase
  end
  assign idcode_sr_EN =
	     tapstate == 4'd0 ||
  ...
  assign instruction_shiftreg_D_IN =
	     (tapstate == 4'd10) ? 5'b10101 : x__h4690 ;
  ...
  assign r1__read__h3385 = { r1__read__h3397, 6'd6 } ;
  assign r1__read__h3397 = { r1__read__h3409, dmistat } ;
  assign r1__read__h3409 = { r1__read__h3421, 3'd7 } ;
  assign r1__read__h3421 = { r1__read__h3433, 1'd0 } ;
  assign r1__read__h3433 = { r1__read__h3445, rg_dmireset } ;
  assign r1__read__h3445 = { 14'd0, rg_dmihardreset } ;
  assign spliced_bits__h4209 = response_from_DM_D_OUT[1:0] | response_status ;
  ...
  assign x1__h4045 = { tdi_i_tdi, dmiaccess_shiftreg[39:1] } ;
  assign x1__h4149 = { dmiaccess_shiftreg[39:34], x__h4017 } ;
  assign x1__h4565 = { dmiaccess_shiftreg[39:2], 2'd3 } ;
  assign x__h3324 = { r1__read__h3385, 4'd1 } ;
  assign x__h3338 = { tdi_i_tdi, dtmcontrol_shiftreg[31:1] } ;
  assign x__h4017 = { response_from_DM_D_OUT[33:2], spliced_bits__h4209 } ;
  assign x__h4690 = { tdi_i_tdi, instruction_shiftreg[4:1] } ;
  assign x__h4885 = { tdi_i_tdi, idcode_sr[31:1] } ;
